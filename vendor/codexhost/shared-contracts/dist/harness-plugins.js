...
const relativeResourceSchema = z
    ...
    !value.startsWith("/") &&
    !value.split("/").some((part) => part === ".." || part === ""), "Plugin resources must be relative paths inside the plugin");
const documentationUrlSchema = z
    .url()
    .refine((value) => /^https:\/\/[^/?#@]+(?:[/?#]|$)/iu.test(value), "Plugin documentation links must be credential-free HTTPS URLs");
...
//# sourceMappingURL=harness-plugins.js.map