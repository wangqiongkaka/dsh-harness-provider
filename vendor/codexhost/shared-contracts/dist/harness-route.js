...
export function encodeHarnessPluginRoute(route) {
...
export function decodeHarnessPluginRoute(value) {
    if (typeof value !== "string" || !value.startsWith(HARNESS_PLUGIN_ROUTE_PREFIX))
        return null;
    ...
    try {
        const json = payload.replace(/[a-f0-9]{2}/gu, (byte) => String.fromCharCode(Number.parseInt(byte, 16)));
...
//# sourceMappingURL=harness-route.js.map