import type { HarnessAccountSnapshot, HarnessSkillCatalog, HarnessCommandCatalog, HarnessId, HarnessInspection, HarnessModelRef, HarnessPermissionModeId, HarnessSessionCapabilities, HarnessSessionImportCandidate, HarnessThinkingOption, HarnessThinkingOptionId, HostInteractionId, HostItemId, HostTurnId, JsonObject, JsonValue, NativeCheckpointRef, NativeSessionRef, NativeTurnRef } from "@codexhost/shared-contracts";
import type { HostUsage } from "./usage.js";
export type { HarnessInspection, HarnessModel, HarnessModelCatalog, HarnessModelRef, HarnessPermissionMode, HarnessPermissionModeCatalog, HarnessPermissionModeId, HarnessSessionCapabilities, HarnessSessionImportCandidate, HarnessThinkingOption, HarnessThinkingOptionId, } from "@codexhost/shared-contracts";
export type HarnessErrorCode = "notInstalled" | "unavailable" | "authenticationRequired" | "sessionNotFound" | "sessionBusy" | "checkpointNotFound" | "unsupported" | "invalidRequest" | "invalidState" | "protocolError" | "processExited" | "nativeFailure" | "internalError";
...
export type OpenSessionInput = CreateSessionInput | ResumeSessionInput | ForkSessionInput | RollbackLastTurnSessionInput;
...
export type HostItem = HostAgentMessageItem | HostReasoningItem | HostContextCompactionItem | HostCommandExecutionItem | HostToolExecutionItem | HostFileChangeItem | HostSubagentDelegationItem;
...
export type HostEvent = SessionStateChangedEvent | SessionUsageChangedEvent | SubagentStateChangedEvent | SubagentTranscriptChangedEvent | TurnStartedEvent | AutonomousTurnStartedEvent | ItemStartedEvent | ItemUpdatedEvent | ItemCompletedEvent | InteractionClosedEvent | TurnCompletedEvent | SessionFaultedEvent;
...
export interface HarnessSession {
    /** Native, user-invocable skills for this Session; no model Turn is started. */
    readonly skills?: {
        list(): Promise<HarnessSkillCatalog>;
    };
...
export interface HarnessAdapter {
    /** Discover native skills for a draft working directory, without a model Turn. */
    inspectSkills?(input: {
        cwd: string;
...
//# sourceMappingURL=text-session.d.ts.map